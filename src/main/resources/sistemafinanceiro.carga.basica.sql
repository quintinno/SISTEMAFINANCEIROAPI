...
INSERT INTO PUBLIC.TB_RECEITA (CODIGO, DATA_PREVISAO_PAGAMENTO, DATA_RECEBIMENTO_PAGAMENTO, IDENTIFICADOR, QUANTIDADE_PARCELA, TIPO_PERIODO_FINANCEIRO, TIPO_RECEITA, TIPO_SITUACAO_PAGAMENTO, VALOR_PAGAMENTO, ID_CATEGORIA_RECEITA, ID_CONTA_BANCARIA_DEPOSITO, ID_RESPONSAVEL_PAGAMENTO, TIPO_FORMA_PAGAMENTO) VALUES 
(NEXTVAL ('public.hibernate_sequence'), '2021-03-13', NULL, 'REC20210313001FIX', 5, 'MENSAL', 'RECEITA_FIXA', 'PENDENTE', 1900.0, 18, 44, 29, 2),
(NEXTVAL ('public.hibernate_sequence'), NULL, '2021-02-09', 'REC20210209001VAR', NULL, 'UNICO', 'RECEITA_VARIAVEL', 'PAGO', 150.0, 14, 44, 34, 3);
...
(NEXTVAL ('public.hibernate_sequence'), NULL, '2021-02-14', 'PENDENTE', 1, NULL, 1900.0, 9500.0, (SELECT codigo FROM tb_receita WHERE identificador LIKE 'REC20210313001FIX')),
(NEXTVAL ('public.hibernate_sequence'), NULL, '2021-03-14', 'PENDENTE', 2, NULL, 1900.0, 9500.0, (SELECT codigo FROM tb_receita WHERE identificador LIKE 'REC20210313001FIX')),
(NEXTVAL ('public.hibernate_sequence'), NULL, '2021-04-14', 'PENDENTE', 3, NULL, 1900.0, 9500.0, (SELECT codigo FROM tb_receita WHERE identificador LIKE 'REC20210313001FIX')),
(NEXTVAL ('public.hibernate_sequence'), NULL, '2021-05-14', 'PENDENTE', 4, NULL, 1900.0, 9500.0, (SELECT codigo FROM tb_receita WHERE identificador LIKE 'REC20210313001FIX')),
(NEXTVAL ('public.hibernate_sequence'), NULL, '2021-06-14', 'PENDENTE', 5, NULL, 1900.0, 9500.0, (SELECT codigo FROM tb_receita WHERE identificador LIKE 'REC20210313001FIX'));
