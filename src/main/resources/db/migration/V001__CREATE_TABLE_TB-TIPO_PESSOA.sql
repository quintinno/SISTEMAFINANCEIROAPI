...
INSERT INTO TB_TIPO_PESSOA (CODIGO, DESCRICAO, SIGLA) VALUES (NEXTVAL('SEQ_TIPO_PESSOA'), 'Pessoa Física', 'PF');
INSERT INTO TB_TIPO_PESSOA (CODIGO, DESCRICAO, SIGLA) VALUES (NEXTVAL('SEQ_TIPO_PESSOA'), 'Pessoa Jurídica', 'PJ');