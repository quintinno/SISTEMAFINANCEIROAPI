...
public class FormaPagamentoController implements Serializable {
	...
	@GetMapping("/pessoa-vinculo-conta-bancaria/{codigoResponsavelPagamento}")
	public ResponseEntity<List<FormaPagamentoEntity>> recuperarFormaPagamentoPessoaVinculoContaBancaria( @PathVariable Long codigoResponsavelPagamento ) {
		return ResponseEntity.ok().body(this.formaPagamentoService.recuperarFormaPagamentoPessoaVinculoContaBancaria(codigoResponsavelPagamento));
	}
